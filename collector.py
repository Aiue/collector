...
class Search:
    ...
    def findClusters(self):
        ...
        logger.debug('(cluster index) Potential match at line %d out of %d. (Between %s and %s)', position+1, len(index), (position < 0 and '(index out of range)' or index[position][0]))
